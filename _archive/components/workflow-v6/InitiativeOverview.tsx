  ...
  const supplierColumns = [
    {
      id: "supplier",
      header: "Supplier",
      render: (supplier: typeof initiative.suppliers[number]) => <span className="v6-orbit-weight-medium">{supplier.name}</span>,
    },
    {
      id: "contracts",
      header: "Contracts",
    ...
    },
    {
      ...
      render: (supplier: typeof initiative.suppliers[number]) => (
        <span className="tabular-nums text-sm v6-orbit-weight-medium">{supplier.overallScore != null ? `${supplier.overallScore}/100` : "—"}</span>
      ),
    },
    {
      id: "updated",
      ...
      <div className="max-w-6xl mx-auto space-y-orbit-m">
        ...
        <header className="space-y-orbit-s flex items-start justify-between gap-orbit-base">
          <div className="space-y-orbit-s">
            <div className="flex items-center gap-orbit-s">
              <h1 className="v6-orbit-heading-2">{initiative.name}</h1>
        ...
        <div className="bg-card border border-border rounded-xl overflow-hidden">
          <div className="px-orbit-m py-orbit-base border-b border-border">
            <h2 className="v6-orbit-heading-strong text-foreground">Suppliers ({initiative.suppliers.length})</h2>
          </div>
          <OrbitTable
