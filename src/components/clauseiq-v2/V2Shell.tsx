...
import { CiqSidebar } from "@/components/clauseiq-v2/Sidebar";
...
/** Shared Orbit-style shell for all v2 surfaces. */
export function V2Shell({ title, subtitle, titleIcon, headerRight, subheader, subheaderClassName, sidePanel, children }: Props) {
  return (
