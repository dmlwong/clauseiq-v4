import { ChevronLeft, FileText, Plus, Play, Eye } from "@/components/clauseiq-v7/v7Icons";
...
import { getInitiative, getSupplier, statusTone, type Contract } from "@/lib/workflow-v7-data";
import type { ContractStatus } from "@/lib/workflow-types";
import { CONTRACT_STATUS_OPTIONS } from "@/hooks/use-contract-status-v7";
