...
import { CpNotificationsRailControl } from "@/components/prototype-cp-v4/shared/CpNotifications";
import { CpIconButton, CpRailButton } from "@/components/prototype-cp-v4/shared/orbit";
  ...
  return (
    <aside className="cp-rail" aria-label="Connected Platform navigation">
      ...
      <div className="cp-rail-items">
        <CpNotificationsRailControl classPrefix="cp" />
...
export function HeaderActions({ uploadCount = "47", showCloud = false }: { uploadCount?: string; showCloud?: boolean }) {
  return (
    <div className="cp-header-actions">
      ...
      {showCloud ? (
        <CpIconButton
          className="cp-icon-button muted"
