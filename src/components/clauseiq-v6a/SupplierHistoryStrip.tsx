  ...
  return (
    <div className="rounded-lg border border-ciq-border bg-ciq-soft/40 mb-orbit-base overflow-hidden">
      ...
      >
        ...
        <Badge variant="outline" className="ml-auto text-[10px] v6-orbit-weight-regular border-ciq/30 text-ciq">
          Same supplier
        </Badge>
        <ChevronDown
            ...
            <li key={p.id}>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-sm v6-orbit-weight-medium text-foreground truncate">{p.contractName}</div>
