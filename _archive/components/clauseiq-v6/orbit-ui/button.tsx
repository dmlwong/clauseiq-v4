...
const fallbackButtonClass =
  "inline-flex h-[var(--orbit-btn-height-medium)] items-center justify-center gap-orbit-s rounded-[var(--orbit-radius-sm)] px-orbit-base text-[length:var(--orbit-text-button-size)] v6-orbit-button-text leading-[var(--orbit-text-button-leading)] transition-colors";
