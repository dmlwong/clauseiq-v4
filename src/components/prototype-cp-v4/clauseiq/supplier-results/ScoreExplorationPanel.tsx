...
import { Button } from "@/components/prototype-cp-v4/clauseiq/orbit-ui/button";
import { DeviationPills } from "@/components/prototype-cp-v4/clauseiq/supplier-results/DeviationPills";
import { SupplierAvatar } from "@/components/prototype-cp-v4/clauseiq/supplier-results/SupplierAvatar";
import { Tooltip, TooltipContent, TooltipTrigger } from "@/components/prototype-cp-v4/clauseiq/orbit-ui/tooltip";
  ...
  return (
    <div className="space-y-orbit-l">
      <section className="space-y-orbit-base">
        <h2 className="v5-orbit-heading-strong">Supplier Output Score Exploration</h2>
      ...
      <section className="space-y-orbit-base">
        <div className="space-y-orbit-xs">
          <h2 className="v5-orbit-heading-strong">Option B Refinements</h2>
          <p className="max-w-3xl text-sm leading-relaxed text-muted-foreground">
      ...
      <section className="space-y-orbit-base">
        <div className="space-y-orbit-xs">
          <h2 className="v5-orbit-heading-strong">Simplified History Options</h2>
          <p className="max-w-3xl text-sm leading-relaxed text-muted-foreground">
    ...
    <section aria-labelledby={`score-concept-${concept.id}`} className="space-y-orbit-base">
      <Card type="Static" state="Default" padding="Base" indicator={false}>
        <div className="space-y-orbit-base">
          <div className="space-y-orbit-xs">
            <h3 id={`score-concept-${concept.id}`} className="v5-orbit-heading-5">
              {concept.label}
            </h3>
          ...
          <div className="rounded-lg border border-border/70 bg-white p-orbit-m">
            <div className="flex items-center gap-orbit-s border-b border-border/70 pb-orbit-s">
              ...
              <div className="min-w-0 flex-1">
                <h4 className="v5-orbit-heading-label truncate">{normalizedSupplier.name}</h4>
  ...
  return (
    <section aria-labelledby={`score-refinement-${refinement.id}`} className="space-y-orbit-base">
      <Card type="Static" state="Feature" padding="Base" indicator={false}>
        <div className="space-y-orbit-base">
          <div className="space-y-orbit-xs">
            <h3 id={`score-refinement-${refinement.id}`} className="v5-orbit-heading-5">
              {refinement.label}
            </h3>
  ...
  return (
    <section aria-labelledby={`score-simplification-${option.id}`} className="space-y-orbit-base">
      <Card type="Static" state="Default" padding="Base" indicator={false}>
        <div className="space-y-orbit-base">
          <div className="space-y-orbit-xs">
            <h3 id={`score-simplification-${option.id}`} className="v5-orbit-heading-5">
              {option.label}
            </h3>
...
function ScorePill({ score }: { score: number }) {
  return (
    <span className="inline-flex items-center rounded-full bg-primary/10 px-orbit-xs py-[2px] text-[11px] v5-orbit-weight-medium text-primary">
      Score {score}
    </span>
  );
}
    ...
    <article className="py-orbit-s">
      <div className="grid grid-cols-[minmax(0,1fr)_auto_auto_auto] items-center gap-orbit-s">
        ...
        <div className="text-right">
          <p className="text-sm v5-orbit-weight-medium text-foreground">{score.score}</p>
          <p className="text-[11px] text-muted-foreground">Score</p>
        </div>
        <div className="min-w-[92px] text-right">
          <p className={cn("inline-flex items-center gap-[4px] text-[11px] v5-orbit-weight-medium", scoreTrendTextClass(score.trend))}>
      ...
      <div className="flex items-start justify-between gap-orbit-s">
        <div className="min-w-0">
          ...
          <div className="mt-orbit-xxs flex flex-wrap items-center gap-x-orbit-s gap-y-orbit-xxs">
            <span className="text-sm v5-orbit-weight-medium text-foreground">Score {score.score}</span>
            <span className={cn("inline-flex items-center gap-[4px] text-[11px] v5-orbit-weight-medium", scoreTrendTextClass(score.trend))}>
              {scoreTrendIcon(score.trend)}
              {plainLanguageDelta(score)}
            </span>
          </div>
  ...
  return (
    <article className="py-orbit-s">
      <div className="grid grid-cols-[minmax(0,1fr)_64px_110px] items-center gap-orbit-s">
        ...
        <div className={cn("text-right text-[11px] v5-orbit-weight-medium", scoreTrendTextClass(score.trend))}>
...
function ScoreMetadata({ score }: { score: ExplorationScore }) {
  return (
    <div className="flex flex-wrap items-center gap-x-orbit-s gap-y-orbit-xxs text-[11px] text-muted-foreground">
      <span className="v5-orbit-weight-medium text-foreground">Score {score.score}</span>
    ...
    <div className="rounded-md border border-border/70 bg-white px-orbit-s py-orbit-xs">
      <div className="flex items-center justify-between gap-orbit-s">
        <div>
          ...
          <p className="text-lg v5-orbit-weight-medium text-foreground">{score.score}/100</p>
        </div>
        <div className={cn("text-right text-xs", scoreTrendTextClass(score.trend))}>
          <div className="inline-flex items-center gap-[4px] v5-orbit-weight-medium">
            {scoreTrendIcon(score.trend)}
    ...
    <div className="my-orbit-s rounded-md border border-border/70 bg-white px-orbit-s py-orbit-s">
      <div className="grid grid-cols-3 gap-orbit-s text-xs">
        <div>
          ...
          <p className="mt-orbit-xxs text-sm v5-orbit-weight-medium text-foreground">{latestScore}</p>
        </div>
        <div>
          <p className="text-muted-foreground">Trend</p>
          <p className="mt-orbit-xxs text-sm v5-orbit-weight-medium text-emerald-700">{trendLabel}</p>
        </div>
        <div>
          <p className="text-muted-foreground">Outputs tracked</p>
          <p className="mt-orbit-xxs text-sm v5-orbit-weight-medium text-foreground">{outputCount}</p>
        </div>
      </div>
    </div>
  );
