      ...
      <div className="max-w-6xl mx-auto space-y-orbit-m">
        ...
        <header className="flex items-start justify-between">
          <div className="space-y-orbit-s">
            ...
            <h1 className="v6-orbit-heading-2">{supplier.name}</h1>
            <div className="flex items-center gap-orbit-s">
              ...
              {supplier.overallScore != null && (
                <span className="text-sm text-muted-foreground">ClauseIQ Score <span className="tabular-nums v6-orbit-weight-medium text-foreground">{supplier.overallScore}/100</span></span>
              )}
            </div>
          </div>
        ...
        <div className="space-y-orbit-base">
          <h2 className="v6-orbit-heading-strong text-foreground">Contracts ({supplier.contracts.length})</h2>
    ...
    <div className="bg-card border border-border rounded-xl p-orbit-m flex items-center justify-between gap-orbit-m">
      <div className="flex items-start gap-orbit-base flex-1">
        ...
        <div className="space-y-orbit-xs">
          <div className="flex items-center gap-orbit-s">
            <h3 className="v6-orbit-heading-strong text-foreground">{contract.name}</h3>
