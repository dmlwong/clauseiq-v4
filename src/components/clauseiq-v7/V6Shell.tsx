...
import { CiqSidebar } from "@/components/clauseiq-v7/Sidebar";
import { cn } from "@/lib/utils";
import { V6OrbitRoot } from "@/components/clauseiq-v7/V6OrbitRoot";
...
/** V7 shell: v4 chrome wrapped around the isolated v7 Orbit theme scope. */
