...
import { CiqSidebar } from "@/components/clauseiq-v3/Sidebar";
...
/** Shared Orbit-style shell for all v3 surfaces. */
export function V3Shell({ title, subtitle, titleIcon, headerRight, subheader, subheaderClassName, sidePanel, children }: Props) {
  return (
