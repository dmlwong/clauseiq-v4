...
import { StateCard, type CardState } from "@/components/clauseiq-v3/StateCard";
import { InitiativeModal } from "@/components/clauseiq-v3/InitiativeModal";
import { CIQ_INITIATIVES, PLAYBOOK_SCOPE_DISCLAIMER, type CiqInitiative } from "@/lib/clauseiq-v3-data";
...
export default function ClauseIQV3() {
