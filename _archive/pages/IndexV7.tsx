...
import { InitiativesList } from "@/components/workflow-v7/InitiativesList";
import { InitiativeOverview } from "@/components/workflow-v7/InitiativeOverview";
import { SupplierPage } from "@/components/workflow-v7/SupplierPage";
import { ContractResults } from "@/components/workflow-v7/ContractResults";
import { CrossSupplierComparison } from "@/components/workflow-v7/CrossSupplierComparison";
import { WizardModal } from "@/components/wizard-v7/WizardModal";
import { useWizardState } from "@/hooks/use-wizard-state-v7";
import { useContractStatus } from "@/hooks/use-contract-status-v7";
import { auditLog } from "@/lib/mock-api";
import { getInitiative, getSupplier, getContract } from "@/lib/workflow-v7-data";
import { V6Shell } from "@/components/clauseiq-v7/V6Shell";
import { V6InitiativeLinkButton } from "@/components/clauseiq-v7/V6InitiativeLinkButton";
import { V4_DELIVERY_INITIATIVE_ID } from "@/data/mock-delivery-engine-v7";
...
const IndexV7 = () => {
  ...
  const deliveryEngineReturnPath = searchParams.get("return") ?? `/delivery-engine-v6/${V4_DELIVERY_INITIATIVE_ID}`;
  ...
  useEffect(() => {
    ...
    if (searchParams.get("resultMode") === "outcome" || searchParams.get("scenario") === "negotiated-reanalysis") return;
        ...
        <ContractResults
          ...
          onBack={() => {
            ...
            if (isClauseIQResultRoute) {
              navigate("/clauseiq-v7/output-panel");
              return;
            }
