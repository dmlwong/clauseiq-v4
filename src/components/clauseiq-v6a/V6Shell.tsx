...
export function V6Shell({
  ...
  return (
    <V6OrbitRoot>
      ...
      >
        <div className="hidden h-screen w-[var(--orbit-sidenav-width)] shrink-0 md:block">
          <div className="fixed inset-y-0 left-0 z-40 h-screen w-[var(--orbit-sidenav-width)]">
        ...
        <div className="flex-1 flex flex-col min-w-0 h-screen">
          ...
          <div className="flex flex-1 min-h-0">
            ...
            <main className={cn("v4-hover-scrollbar clauseiq-v6-canvas-grid flex-1 min-h-0 overflow-y-auto overscroll-contain", mainClassName)}>
              {children}
            </main>
            {rightPanel && (
              <aside
