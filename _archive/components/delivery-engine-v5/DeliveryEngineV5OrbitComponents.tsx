...
export function StatusBadgeV5({ status }: { status: DeliveryStatus }) {
  return (
    <Chip
      label={status}
      size="Small"
...
export function RagIndicatorV5({
  status,
  compact = false,
  onChange,
}: {
...
export function MetricV5({ label, value }: { label: string; value: ReactNode }) {
  return (
    <div>
...
export function CompletedToolActionCardV5({
  toolName,
  description,
...
export function ToolCoverageCardV5({
  tool,
  index,
  onAction,
}: {
...
export function ContentSearchTableV5({ documents }: { documents: DeliveryDocument[] }) {
