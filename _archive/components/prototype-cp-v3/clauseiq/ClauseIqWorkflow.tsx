...
import { Card, Chip, Dropzone, FA, FaIcon, InlineBanner, Text } from "@orbit-cp";

import { Button } from "@/components/prototype-cp-v3/clauseiq/orbit-ui/button";
import { CpInlineBanner } from "@/components/prototype-cp-v3/clauseiq/orbit-ui/inline-banner";
  ...
  return (
    <StateCard state="default">
      <div className="space-y-orbit-base">
        <h2 className="v6-orbit-heading-5">Next, you can...</h2>
            ...
            <table className="w-full table-fixed border-collapse text-left text-orbit-sm">
              ...
              <thead>
                <tr className="border-b border-orbit-border">
                  ...
                  <th scope="col" className="v6-orbit-heading-strong px-orbit-base py-orbit-base">Action</th>
                </tr>
              </thead>
              <tbody>
          ...
          {playbookSelected ? (
            ...
            <>
              ...
              <p className="mt-orbit-base text-orbit-sm text-orbit-fg-secondary">
                ...
                <a
                  href="/prototype-cp-v3?view=playbooks"
                  target="_blank"
                  rel="noreferrer"
      ...
      <div className="rounded-orbit-md bg-[var(--orbit-color-status-high-bg-no-status)] p-orbit-base text-[var(--orbit-color-text-primary)]">
        <div className="flex items-start gap-orbit-xs">
          ...
          <div className="min-w-0 flex-1 space-y-orbit-s">
            <div className="v6-orbit-text-body v6-orbit-weight-bold">Using the general benchmark</div>
            <p className="v6-orbit-text-body">
...
export function BenchmarkCombobox({
  ...
  return (
    <div className="prototype-cp-v3-benchmark-combobox space-y-orbit-xs">
...
export function ClauseIqDropzone({ onFile }: { onFile: (file: File | null) => void }) {
  return (
    <div className="prototype-cp-v3-upload-dropzone">
      <Dropzone
