...
import {
  ...
  ChevronRight, ListChecks, FilePlus2, Building2, Lock,
} from "lucide-react";
import { Button } from "@/components/ui/button";
import { toast } from "@/components/ui/sonner";
import { V2Shell } from "@/components/clauseiq-v2/V2Shell";
import { StateCard, type CardState } from "@/components/clauseiq-v2/StateCard";
import { InitiativeModal } from "@/components/clauseiq-v2/InitiativeModal";
...
} from "@/components/clauseiq-v2/supplier-results";

type Step = "welcome" | "select" | "upload" | "processing" | "results";

const PROCESSING_MS = 3_000;

export default function ClauseIQV2() {
  ...
  const masterDetailState = useMasterDetailState(mockInitiative);
  ...
  return (
    <V2Shell
      ...
      sidePanel={
        wideResults ? (
          <MasterSupplierRail state={masterDetailState} />
        ) : undefined
      }
    >
      <div
            ...
            {resultsVisible && (
              <div ref={resultRef} className="space-y-4">
                <ResultsContent
                  ...
                  onViewResult={() =>
                    navigate("/initiatives-v2?view=results&initiativeId=init-1&supplierId=sup-1&contractId=ct-1&source=clauseiq")
                  }
