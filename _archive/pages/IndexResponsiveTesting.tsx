// Responsive Testing — duplicated from prototype v5 so layout experiments do not affect v5.
// Edit freely without touching src/pages/IndexV5.tsx.
...
export default IndexResponsiveTesting;
