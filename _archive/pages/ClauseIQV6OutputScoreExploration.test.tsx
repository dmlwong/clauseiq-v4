...
import ClauseIQV6OutputScoreExploration from "./ClauseIQV6OutputScoreExploration";
...
describe("ClauseIQ V6 output score exploration", () => {
  it("renders the dedicated route with all three score concepts", () => {
    render(
      <MemoryRouter initialEntries={["/clauseiq-v6/output-score-exploration"]}>
        <TooltipProvider>
          <Routes>
  ...
  it("keeps the live output-panel route free of score exploration UI", () => {
    render(
      <MemoryRouter initialEntries={["/clauseiq-v6/output-panel"]}>
        <TooltipProvider>
          <ClauseIQV6 forceResults resultsLayout="output-panel" />
        </TooltipProvider>
      </MemoryRouter>,
    );
